...
std::string usageText(const Args& args, bool fmt) {
    ...
    oss << bold << "The setup and the infrastructure" << rst << "\n"
              ...
              << "  help          Show this help\n"
              << "  login         Login to a Matrix homeserver (--mas: native password login, no browser)\n"
    ...
    oss << bold << "Examples:" << rst << "\n"
              ...
              << "  progressive-cli register --mas --homeserver https://xmr.se --username newuser --password s3cret --email you@xmr.se\n"
              << "  progressive-cli login --mas --homeserver https://xmr.se --username newuser --password s3cret\n"
