...
void printUsage() {
    std::cout << "progressive-cli - the Matrix chat client and coding agent, designed to work in the terminal\n\n"
              ...
              << "  progressive-cli demo                        # interactive demo session\n"
              ...
              << "  --agent <prompt>  run the local coding agent (with the frame)\n"
              << "  --agent-provider openai|anthropic   LLM backend override\n"
              << "  --agent-endpoint <url> --agent-model <m> --agent-key <k>\n"
              << "  --agent-trust <allow|ask|deny>      shell permission level\n"
              ...
              << "  --thread <N|id>  open a thread by number or id (right panel)\n"
              ...
              << "  --ids         Show event IDs\n"
              << "\nQuick start:\n"
              << "  progressive-cli demo populate          # offline demo\n"
              << "  progressive-cli rooms                  # list rooms\n"
              << "  progressive-cli view \"#general\" --ts  # view messages\n"
              << "  progressive-cli serve --demo            # web demo (HTTP API server)\n"
              << "  progressive-cli tui                    # terminal UI\n"
              << "\nShell completions:\n"
