// src/ascii_ui.cpp — the ASCII frame builder: drawFrameImpl, the
// public thin wrappers, cmdAttachFile and the command registration.
// The text helpers moved to ascii_ui_text.cpp.
