...
// (terminalWidthImpl .. roomLastEvent): codepoint widths, clipping, wrap,
// the event-body renderers and the room-label helpers. Split out of
// ascii_ui.cpp so no translation unit stays over ~1000 lines.
